...
import { X, Calendar, Clock, ChevronRight, CheckCircle, Delete } from 'lucide-react';
                ...
                <div className="flex-1 flex flex-col px-6 overflow-y-auto">
                    ...
                    <div className="space-y-4 mb-8">
                        ...
                        <div className="flex items-center gap-3 bg-white dark:bg-white/5 p-4 rounded-2xl border border-slate-100 dark:border-white/5">
                            ...
                            <span className="text-slate-900 dark:text-white font-medium">Today, Oct 24</span>
                            <div className="ml-auto flex items-center gap-2">
                                <span className="text-slate-500 text-sm">14:30</span>
                    ...
                    <button 
                        onClick={() => navigate('/')}
                        className="w-full bg-primary hover:bg-primary-dark text-background-dark font-bold py-4 rounded-2xl shadow-xl shadow-primary/20 transition-all active:scale-[0.98] mb-8 flex items-center justify-center gap-2"
                    >
